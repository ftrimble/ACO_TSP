...
\begin{figure}
  \includegraphics[height=2.4in]{plots/pr2392.eps}
  \caption{An Optimal TSP Tour}
\end{figure}
...
It is important to understand how exactly ACO works before we dive into 
...
Given this background on the algorithm, it becomes fairly 
